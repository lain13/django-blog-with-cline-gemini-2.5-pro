...
class TemplateInheritanceTest(TestCase):
    ...
    def test_post_list_uses_base_template(self):
        """
        post_list 뷰가 렌더링하는 페이지에 base.html의 main 태그가 포함되어 있는지 확인
        """
    ...
    def test_post_detail_uses_base_template(self):
        """
        post_detail 뷰가 렌더링하는 페이지에 base.html의 main 태그가 포함되어 있는지 확인
        """
    ...
    def test_post_form_uses_base_template(self):
        """
        post_form 뷰가 렌더링하는 페이지에 base.html의 main 태그가 포함되어 있는지 확인
        """
    ...
    def test_post_confirm_delete_uses_base_template(self):
        """
        post_confirm_delete 뷰가 렌더링하는 페이지에 base.html의 main 태그가 포함되어 있는지 확인
        """
        self.client.login(username='testuser', password='password')
    ...
    def test_search_results_uses_base_template(self):
        """
        search_results 뷰가 렌더링하는 페이지에 base.html의 main 태그가 포함되어 있는지 확인
        """
