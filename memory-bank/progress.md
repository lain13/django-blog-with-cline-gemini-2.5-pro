...
- **14. 사용자 프로필 기능 (User Profile Feature)**
  ...
  - [x] **Phase 3: 프로필 수정 (Profile Update)**
...
- [x] **보안 설정 리팩토링**: `python-dotenv`를 사용하여 `SECRET_KEY` 및 기타 민감 정보를 `.env` 파일로 분리하고, `.gitignore`에 추가합니다.
